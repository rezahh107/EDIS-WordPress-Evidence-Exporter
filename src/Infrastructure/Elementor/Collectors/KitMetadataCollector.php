...
final class KitMetadataCollector implements EvidenceCollector
{
    ...
    public function collect(CollectionContext $context, array $artifacts = []): CollectionResult
    {
        ...
        return new CollectionResult(
            ...
            $data,
            [],
            [['source_location' => 'wp_posts:' . $kitId]],
            ['collector_id' => $this->id(), 'adapter_id' => 'elementor.active-kit', 'adapter_version' => '1.1.0', 'source_kind' => 'ELEMENTOR_KIT', 'retrieval_strategy' => 'active_kit_option_or_manager'],
        );
    }
