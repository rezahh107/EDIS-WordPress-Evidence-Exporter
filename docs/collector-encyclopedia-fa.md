...
- **Schema:** `urn:edis:schema:bundle:selection-snapshot` نسخه `1.2.0`
...
- **Schema:** `urn:edis:schema:index:site-settings` نسخه `1.1.0`
...
- **Schema:** `urn:edis:schema:elementor:kit-settings` نسخه `1.1.0`
...
- **Schema:** `urn:edis:schema:elementor:document-source` نسخه `1.1.0`
